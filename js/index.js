...
function renderGlutenFreeCrust() {
  ...
  let buttonGluten = document.querySelector('.btn.btn-crust')
  buttonGluten.addEventListener('click', () =>
  {
    if(state.glutenFreeCrust)
    {
      buttonGluten.className = 'btn btn-crust'
    }
    else{
      buttonGluten.className = 'btn btn-crust active'
    }
  })
}
